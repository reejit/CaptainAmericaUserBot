...
UPSTREAM_REPO_URL = (os.environ.get("UPSTREAM_REPO_URL")
                     or "https://github.com/reejit/CaptainAmericaUserBot.git")
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("I'm [CaptainAmericaUserBot](https://github.com/reejit/CaptainAmericaUserBot) modules helper...\nplease make your own bot, don't use mine 😋")
            else:
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@UserButt"):
                ...
                result = builder.article(
                    "CaptainAmericaUserBot Helper",
                    text="List of Modules",
                    buttons=[],
                    link_preview=True)
            else:
                result = builder.article(
                    "CaptainAmericaUserBot",
                    text="""You can convert your account to bot and use them. Remember, you can't manage someone else's bot! All installation details are explained from GitHub address below.""",
                    buttons=[
                        [
                            custom.Button.url(
                                "GitHub Repo",
                                "https://github.com/reejit/CaptainAmericaUserBot"),
                            custom.Button.url(
                                "Support",
                                "https://t.me/CaptainAmericaUserBotSupport")],
                    ],
                    link_preview=False,
                )
